...
public class SplashActivity extends AppCompatActivity {
    ...
    private void checkPermissionsAndProceed() {
        if (Build.VERSION.SDK_INT==Build.VERSION_CODES.M && !getPermissionStatus(this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
    ...
    public void showMarshmallowPermissionDialogue() {
        ...
        no.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                myDialog.dismiss();
                Toast.makeText(SplashActivity.this, "Cannot show Files.Permission Not Granted", Toast.LENGTH_LONG).show();
                checkPermissionsAndProceed();
            }
        });
        myDialog.show();
